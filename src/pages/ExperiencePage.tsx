...
export function ExperiencePage() {
  return (
    <div className="inner-page">
      <header className="page-intro"><p className="eyebrow">02 / Experience</p><h1>Learning by building<br />complete systems.</h1><p>Hands-on experience across web development, backend architecture, applied machine learning, and product delivery.</p></header>
